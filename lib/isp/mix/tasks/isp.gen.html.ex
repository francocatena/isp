defmodule Mix.Tasks.Isp.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix isp.gen.html Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix isp.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix isp.gen.html Sales User users --web Sales
  ...
  a `--table` option may be provided. For example:
      ...
      mix isp.gen.html Accounts User users --table cms_users
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix isp.gen.html can only be run inside an application directory")
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/isp.gen.html", binding, files)
